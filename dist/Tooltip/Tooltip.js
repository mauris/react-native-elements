...
export const Tooltip = (_a) => {
    ...
    return (React.createElement(View, { collapsable: false, ref: renderedElement },
        ...
        React.createElement(ModalComponent, { transparent: true, visible: visible, onShow: onOpen, animationType: "fade" },
