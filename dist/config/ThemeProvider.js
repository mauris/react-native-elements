...
export const createTheme = (theme) => {
    return Object.assign(Object.assign({}, theme), deepmerge({ lightColors, darkColors }, {
...
const separateColors = (theme, themeMode) => {
    const { darkColors: themeDarkColors = {}, lightColors: themeLightColors = {}, mode = themeMode } = theme, restTheme = __rest(theme, ["darkColors", "lightColors", "mode"]);
    const themeColors = mode === 'dark' ? themeDarkColors : themeLightColors;
    return Object.assign({ colors: themeColors, mode }, restTheme);
};
